...
print(employees.items()) # можно получить пары - ключ+значение
...
# Вариант 2.1 - списковые включения (однострочники) распаковка кортежей по каждой паре, которую вытаскиваем
